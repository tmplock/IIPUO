    ...
    if (iClass == 4) {
        let list = await db.sequelize.query(`
            SELECT
                ...
                0 as iBaccaratRollingMoney,
                0 as iUnderOverRollingMoney,
                0 as iSlotRollingMoney,
                ...
                IFNULL((SELECT sum(iSettleViceAdmin) FROM SettleSubRecords WHERE strGroupID LIKE CONCAT(t4.strGroupID, '%') AND strQuater='${strQuater}' AND iTotal > 0),0) as iSettleTotal,
                ...
                IFNULL((SELECT sum(iSettle) FROM SettleSubRecords WHERE strGroupID LIKE CONCAT(t4.strGroupID, '%') AND strQuater='${strQuater}' AND iTotal > 0),0) as iSettleVice,
