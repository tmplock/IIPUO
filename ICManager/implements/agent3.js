...
let inline_GetPopupAgentInfo = async (strGroupID, iClass, strNickname) => {
    ...
    if (iClass > 3) {
        ...
        SELECT              
            ...
            fSettleBaccarat, fSettleResetBaccarat, fSettleSlot, fSettlePBA, fSettlePBB,
            ...
            const [users] = await db.sequelize.query(
                `
                    SELECT
                        ...
                        u.fSettleBaccarat, u.fSettleResetBaccarat, u.fSettleSlot, u.fSettlePBA, u.fSettlePBB,
...
var inline_GetComputedAgentList = async (strGroupID, iClass, dateStart, dateEnd, strSearchNickname, bTotal) => {
    ...
    const [list] = await db.sequelize.query(`
        ...
        t2.fSettleBaccarat, t2.fSettleResetBaccarat, t2.fSettleSlot, t2.fSettlePBA, t2.fSettlePBB, t2.createdAt, t2.updatedAt,
