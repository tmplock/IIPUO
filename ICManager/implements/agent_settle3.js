    ...
    if (iClass == 4) {
        let list = await db.sequelize.query(`
            SELECT
                ...
                IFNULL((SELECT iSettleAcc FROM SettleRecords WHERE strNickname = t4.strNickname AND strQuater='${strQuater2}'),0) as iSettleAfter2,
        ...
        let list = await db.sequelize.query(`
            SELECT
                ...
                IFNULL((SELECT iSettleAcc FROM SettleRecords WHERE strNickname = t5.strNickname AND strQuater='${strQuater2}'),0) as iSettleAfter2,
